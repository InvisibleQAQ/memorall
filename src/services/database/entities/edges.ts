...
export const edge = pgTable(
	tableName,
	{
		...
		factEmbeddingSmall: vector("fact_embedding_small", { dimensions: 384 }),
		factEmbedding: vector("fact_embedding", { dimensions: 768 }),
		factEmbeddingLarge: vector("fact_embedding_large", { dimensions: 1536 }),
		typeEmbeddingSmall: vector("type_embedding_small", { dimensions: 384 }),
		typeEmbedding: vector("type_embedding", { dimensions: 768 }),
		typeEmbeddingLarge: vector("type_embedding_large", { dimensions: 1536 }),
