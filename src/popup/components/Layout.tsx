...
} from "@/popup/stores/embedding-settings";
import { useLanguage } from "@/popup/i18n/hooks/useLanguage";
...
import { CopilotTrigger } from "@/popup/components/atoms/copilot";
import { getCurrentEmbeddingSize } from "@/utils/embedding-size-config";
import { ProcessMonitor } from "@/popup/components/molecules/ProcessMonitor";
import { VietnamFlag, USFlag } from "@/popup/components/atoms/flags";
